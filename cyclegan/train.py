...
def save_losses_to_csv(filepath, epoch, generator_loss, discriminatorA_loss, discriminatorB_loss):
	...
	with open(filepath, mode='a', newline='') as file:
		...
		if write_header:
			writer.writerow(['Epoch', 'Generator Loss', 'DiscriminatorA Loss', 'DiscriminatorB Loss'])  
		writer.writerow([epoch, generator_loss, discriminatorA_loss, discriminatorB_loss])


# load train dataloader
pop_dir = "/DATA/music/dataset/wav_fma_split/Pop/pop_train"
...
# load train dataloader
rock_dir = "/DATA/music/dataset/wav_fma_split/Rock/rock_train"
...
def train(model, dataloaderA, dataloaderB, optimizer_generator, optimizer_discriminatorA, optimizer_discriminatorB,
    ...
    for i in range(start_epoch, epochs):
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig('/DATA/music/cyclegan_path/loss_curve.png')
        plt.show()
...
epochs = 1000
checkpoint_path = '/DATA/music/cyclegan_path/cyclegan_checkpoint.pth'
...
loss_csv_path = '/DATA/music/cyclegan_path/loss.csv'
