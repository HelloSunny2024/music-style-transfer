...
pop_dir = "/DATA/music/dataset/wav_fma_split/Pop/pop_val"
...
model = torch.load('/DATA/music/cyclegan_path/cyclegan_checkpoint.pth', map_location=device)
print(type(model))
print(model.keys())
...
output_dir = "/DATA/music/converted_features"
