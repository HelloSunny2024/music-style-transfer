...
if __name__ == '__main__':
    input_dir = "/home/quincy/DATA/music/dataset/wav_fma_split/Pop/pop_val"
    output_dir = "/home/quincy/DATA/music/features/wav_fma_split/Pop/pop_val"
    dataset = AudioDataset(input_dir, target_time_steps=2580,
                           save_features=True, feature_save_dir=output_dir)
    dataloader = DataLoader(dataset, batch_size=1, shuffle=True)

    # for idx, (mel_features, filenames) in enumerate(dataloader):
    #     print(f"Sample {idx} - Mel Feature Shape: {mel_features.shape}")
    #     if idx == 10:
    #         break
